/*
The idea is to let rules evolve and see if life or something else happens
You are always born from one parent though, 
randomly chosen between whoever is there needed for you to be born
*/
